...
plt.title('Wall Thickness vs. Structural Hot Wall Temperatures', fontsize=15, fontweight='bold')
plt.xlabel('Wall Thickness (mm)', fontsize=13)
plt.ylabel('Hot Wall Temperature (K)', fontsize=13)
...
plt.title('Wall Thickness vs. Fluid Interface Cold Wall Temperatures', fontsize=15, fontweight='bold')
plt.xlabel('Wall Thickness (mm)', fontsize=13)
plt.ylabel('Cold Wall Temperature (K)', fontsize=13)
plt.grid(True, linestyle='--', alpha=0.6)
...
plt.title('Channel Diameter vs. Water Velocity', fontsize=15, fontweight='bold')
plt.xlabel('Channel Diameter (mm)', fontsize=13)
plt.ylabel('Water Velocity (m/s)', fontsize=13)
plt.grid(True, linestyle='--', alpha=0.6)
plt.legend()
plt.tight_layout()
...
plt.yscale('log') 
plt.title('Target Hot Wall Temperature vs. Required Water Velocity', fontsize=15, fontweight='bold')
plt.xlabel('Target Hot Wall Temperature (K)', fontsize=13)
plt.ylabel('Required Water Velocity (m/s) [Log Scale]', fontsize=13)
