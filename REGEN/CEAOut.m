...
subSonicARatios = engineContour(1:786,3)';%[linspace(10.496,1.1,300),linspace(1.101,1,200)];
superSonicARatios = engineContour(786:end,3)';% [linspace(1.001,1.1,200),linspace(1.101,5.005,300)];
...
subSonicContour = contour(1:785,:); % contour(1:783,:);
supSonicContour = contour(786:end,:); % contour(784:end,:);
